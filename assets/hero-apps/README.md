...
The White theme uses `github-ink.svg`, `cursor-ink.svg`, and `notion-ink.svg`: the same contours as their white counterparts, filled with Voxden charcoal (`#1C2822`). Other brand colors are unchanged.
