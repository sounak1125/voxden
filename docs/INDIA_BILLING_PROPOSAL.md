...
- The server still meters a configurable Pro allowance and uses the current cloud recognizer. Since 13 September 2026 the default is 15 cloud hours (900 credits) per credit month, and a subscriber's first credit month is a one-time welcome offer of 20 hours (1,200 credits). Credit months run from one billing date to the next. Billing shows the actual allowance. Unlimited cloud routing remains proposed and is not advertised as implemented.
...
For 100% current-recognizer traffic at its launch price, modeled inference is INR 11.605/hour and contribution at ten hours is about INR 146.47. At the 15-hour monthly allowance, a subscriber who uses all of it still contributes about INR 88.45; in the 20-hour welcome month, about INR 30.43. Contribution reaches zero near 22.6 hours (about 1,357 credits), so both allowances keep every subscriber above break-even while this price holds. The development relay measured USD 0.097 per billed hour across 451 requests on 11–13 September 2026, consistent with the list price. If 80/20 routing remains but the recognizer hypothetically rises to USD 0.36/hour, blended inference becomes INR 10.7316/hour and ten-hour contribution is about INR 155.20. This future rate is a stress-test assumption, not a prediction.
