...
contextBridge.exposeInMainWorld('voxden', {
  ...
  polishQuote: (text) => ipcRenderer.invoke('polish-quote', text),
  polishText: (text, mode) => ipcRenderer.invoke('polish-text', text, mode),
  polishEntry: (id, mode) => ipcRenderer.invoke('polish-entry', id, mode),
  copyEntry: (id, which) => ipcRenderer.invoke('history-copy', id, which),
