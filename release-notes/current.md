...
- **Less to download and manage.** Local sentence correction, its language packs, and the related rewrite and context controls have been removed. Built-in cleanup still handles fillers, false starts, and punctuation. If an older language pack is still on this PC, the 1.0.19 installer removes it when present, and the next launch removes any leftover files.
